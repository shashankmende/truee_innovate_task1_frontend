...
//         sharingPermissions
//       );
//       setData(filteredPositions);
//       console.log(filteredPositions, "myquestions");
//     } catch (error) {
...
//             <button className="text-md" onClick={toggleSidebar}>
...
//                               {question.isCustom && (
//                                 <div className="relative w-8 text-center mt-1">
//                                   <button
...
const MyQuestionsList = ({  sectionName ,updateQuestionsInAddedSectionFromQuestionBank, interviewQuestionsList, setInterviewQuestionsList, section, questionBankPopupVisibility }) => {
