...
const MyQuestionsList = ({ section, questionBankPopupVisibility }) => {
...
// // added by shashank
//   const onClickAddButton = (listName,question,indx)=>{
//     // console.log(item)
//     const requiredArray = myQuestionsList[listName]
//     const requiredObj  = requiredArray.map((item,index)=>index===indx?{...item,isAdded:true}:item)
//     setMyQuestionsList(prev=>({
//       ...prev,
//       [listName]:requiredObj
//     }))
...
// {/* // Added by Shashank on [02/01/2025]: Feature to handle add question to interviewer section when clicked on add button */}
// <button
//   className={`${question.isAdded ? "bg-[gray] cursor-not-allowed px-2 text-sm py-1" : "bg-custom-blue px-2 py-1"} text-white rounded-md`}
//   onClick={() => !question.isAdded && onClickAddButton(listName, question, index)}
//   disabled={question.isAdded}
// >
//   {question.isAdded ? "Added" : "Add"}
// </button>
