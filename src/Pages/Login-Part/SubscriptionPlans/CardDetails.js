...
const CardDetails = () => {
  const {
    ...
    console.log("planDetailsInvoiceId", planDetails.invoiceId);
    ...
    useEffect(() => {
        if (planDetails) {
            ...
            setCardDetails((prevDetails) => ({
                ...prevDetails,
                tenantId: planDetails.user?.tenantId || "",
                ownerId: planDetails.user?.ownerId || "",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (status === "paid") {
                alert("Payment successfully compeleted!");
