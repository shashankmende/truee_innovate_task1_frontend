...
// const MyQuestionsList1 = forwardRef(({ question, fromcreate, closeDropdown, fromform, onSelectList = () => { }, errors = {} }, ref) => {
...
//             if (editingSectionId) {
//                 await fetch(`${process.env.REACT_APP_API_URL}/api/lists/${editingSectionId}`, {
//                     method: "PUT",
...
//         if (!isSelected) {
//             // If not selected, add the candidate to the selected list
//             setSelectedCandidates(prevState => [
//                 ...prevState,
//                 { label: service.label, _id: service._id }
//             ]);
//         } else {
//             // If selected, do nothing or show a message that it's already selected
...
//     // Pass selectedCandidates to the parent whenever it updates
//     useEffect(() => {
...
//                                         }
//                                     }}
//                                     // disabled={selectedListIds.includes(list._id)}
//                                 />
//                                 {list.label}
//                             </label>
//                         ))}
...
//                         // onClick={() => {
//                         //     const questionId = disableToggleForQuestion ? undefined : question._id;
//                         //     handleAddToList(selectedListIds, questionId);
//                         //     console.log("selectedListIds", selectedListIds);
//                         //     if (!disableToggleForQuestion) {
//                         //         console.log("Question ID included:", questionId);
//                         //     }
//                         // }}
//                         >
//                             Add
...
//                         <div
//                             className={`border-b focus:outline-none mb-5 w-full min-h-5 ${errors?.tenentListId
//                                 ? "border-red-500"
...
//                                 <button type="button" onClick={clearRemoveCandidate} className="bg-slate-300 rounded px-2 absolute top-0 text-sm right-4">X</button>
//                             )}
//                         </div>
//                         <MdArrowDropDown className="absolute top-0 text-gray-500 text-lg mt-1 cursor-pointer right-0" onClick={togglePopup} />
//                         {showPopup && (
//                             <div ref={popupRef} className="absolute  w-full z-10 rounded-md bg-white shadow-lg mt-1 max-h-60 overflow-y-auto">
...
//                                     </div>
//                                 </div>
//                                 {/* Render filtered lists with the <ul> approach */}
//                                 <ul>
//                                     {createdLists
//                                         .filter((service) =>
