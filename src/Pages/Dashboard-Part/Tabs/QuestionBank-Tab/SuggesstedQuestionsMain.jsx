  ...
  const ReturnSearchFilterSection = () => {
    return (
      <div className={` flex gap-4 justify-between items-center`}>
        ...
        <div
          className={` ${
            section === "Popup" && !questionBankPopupVisibility
              ? "w-[35%] "
              : "w-1/2"
          } `}
        >
              ...
              <span
                className={`border ${
                  section === "Popup" && !questionBankPopupVisibility
                    ? "p-1 mr-1"
                    : "p-2 mr-2"
                }  text-xl sm:text-md md:text-md rounded-md ${
        ...
        <ul
          className={` ${
            ...
            section === "Popup"
              ? "h-[calc(100vh-280px)]"
              : "h-[calc(100vh-250px)]"
          } flex flex-col gap-4 my-2 overflow-y-scroll  overflow-hidden pr-2 ${
            section === "Popup" ? "text-sm" : "text-base"
          }`}
        >
            ...
            paginatedData.map((item, index) => (
              <li key={index} className="border-[1px] border-[gray] rounded-md">
                <div className="flex justify-between  items-center border-b-[1px] border-[gray]">
                  ...
                  <div
                    className={`flex justify-center text-center p-2 border-r border-l border-[gray] ${
                      section === "Popup" && !questionBankPopupVisibility
                        ? "w-[15%]"
                        : "w-[10%]"
                    }`}
