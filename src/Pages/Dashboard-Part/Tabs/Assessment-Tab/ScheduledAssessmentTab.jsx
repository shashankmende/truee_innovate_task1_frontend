...
const ScheduledAssessmentTab = ({
  ...
  return (
    <>
      { showMainContent&& <div className="mt-4">
        {/* Header */}
      ...
      {isLoading && (
            <div className="fixed top-0 right-0 bg-black  bg-opacity-50 flex items-center justify-end z-[999] w-1/2 h-full">
              <div className=" w-full flex justify-center h-full items-center">
                <span className="bg-white p-4  rounded shadow-lg">Sending email...</span>
              </div>
            </div>
          )}
      ...
      {showSharePopup && (
        <div className="fixed z-50  inset-0 top-0 right-0 left-0 h-full bg-[#8080805c] flex justify-end">
          <div className="w-1/2 bg-white ">
            ...
            <div className="flex gap-5 mb-5 relative px-8 py-16" ref={candidateRef}>
              <div>
                <label
                  htmlFor="Candidate"
          ...
          <div className="fixed bottom-0 right-0 w-1/2 border-t flex justify-end  p-2 cursor-pointer" onClick={handleShareClick}>
              <div className="py-2 px-4 bg-custom-blue text-white rounded-md "><button>share</button></div>
          </div>
