  ...
  return (
      <div className={`${section==="interviewerSection" ? "h-[95%] shadow-md  w-[95%] bg-white ":""}`}>
        ...
        {activeTab === "SuggesstedQuestions" && (
          <>
          <SuggesstedQuestions questionBankPopupVisibility={questionBankPopupVisibility} section={section}/>
          </>
        )}
        {activeTab === "MyQuestionsList" && (
          <div>
            <MyQuestionListMain questionBankPopupVisibility={questionBankPopupVisibility} section={section}/>
          </div>
        )}
      </div>
  );
...
// const QuestionBank = ({section,closeQuestionBank,questionBankPage}) => {
//   const [activeTab, setActiveTab] = useState("SuggesstedQuestions");
