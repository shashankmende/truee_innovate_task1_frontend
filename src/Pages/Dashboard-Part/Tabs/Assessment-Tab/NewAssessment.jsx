                      ...
                      <div>
                        ...
                        <div className="overflow-x-auto relative min-h-[500px]" style={{ overflowX: "auto" }}>
                          <div className="border p-2 flex justify-between bg-gray-200 items-center">
                            ...
                            offsetX={-50}
                            >
                              {closeAddSectionPopup=> <div className="">
                                <div className=" bg-white flex flex-col gap-4 p-4 rounded-sm shadow-lg  ">
                                  <div className="flex flex-col gap-2">
                                    ...
                                    <input value={sectionName} id="assessment-section-name" type="text" placeholder="section name" className=" px-2 py-1 rounded-sm border-[2px] border-[#80808030]  outline-none" onChange={(e)=>setSectionName(e.target.value)}/>
                                  </div>
                                  <div className="self-end flex justify-end">

                                    <button className="bg-custom-blue rounded-sm px-2 py-[0.5] text-white " onClick={()=>handleAddSection(closeAddSectionPopup)}>Add</button>
                                  </div>
                                    </div>
                              </div>}
                            </Popup>
                            ...
                            matchingSection.map((sectionName, index) => (
                              <div key={index} className="text-md justify-between">
                                  ...
                                  <div className="flex">
                                    ...
                                    >
                                      <p className="rounded px-2 ml-2 sm:ml-0 cursor-pointer text-custom-blue">
                                        Add Questions uhu  he
                                      </p>
                                    </div> */}
                                    <div className="flex items-center sm:text-xs">
                                      <Popup trigger={<button  className="rounded px-2 ml-2 sm:ml-0 cursor-pointer text-custom-blue">Add Questions</button>}
                                      closeOnDocumentClick={false} 
                                      >
                                      {closeQuestionBankPopupInAssessment=> <div className=" fixed flex justify-center items-center bg-white  left-0 top-0 bottom-0 w-full ">
                                        

                                        <QuestionBank sectionName={sectionName} updateQuestionsInAddedSectionFromQuestionBank={updateQuestionsInAddedSectionFromQuestionBank} closeQuestionBank={closeQuestionBankPopupInAssessment} section="assessment"/>
                                ...
                                <div>
                                  ...
                                  {addedSections.map(each=>{
                                    if (each.SectionName===sectionName){
                                      return (
                                        each.Questions.map((question,questionIndex)=>(
                                ...
                                >
                                  ...
                                  {  addedSections[sectionName]?.Questions?.map((question, questionIndex) => (
                                      <div key={question._id} className="border sm:p-0 border-gray-300 mb-2 text-sm">
                                        <div className="flex justify-between">
                                          <div className="flex items-center gap-1">
                                            <div className="relative group mx-3">
